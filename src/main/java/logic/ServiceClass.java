...
public class ServiceClass {
    ...
    private void setUser(String name, String surname, String email, String role, String cellphone) {
        User user = new User();
        user.setName(name);
    ...
    private void showUserInformation(List<User> users) {
        for (User us : users) {
    ...
    private void writeAndRead(User user) {
    ...
    private void deleteMail(String email){
        try {
